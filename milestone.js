...
function replace(img,indx) {
    ...
    let imgWpawn = `<img class="Wpawn piece" data-indx="${indx}" src="./chessSetIcons/Wpawn.png" alt=""></img>`;
    let imgBpawn = `<img class="Bpawn piece" data-indx="${indx}" src="./chessSetIcons/Bpawn.png" alt=""></img>`;
    let imgWrook = `<img class="Wrook piece" data-indx="${indx}" src="./chessSetIcons/Wrook.png" alt="">`;
    let imgBrook = `<img class="Brook piece" data-indx="${indx}" src="./chessSetIcons/Brook.png" alt="">`;
    let imgWknight = `<img class="Wknight piece" data-indx="${indx}" src="./chessSetIcons/Wknight.png" alt="">`;
    let imgBknight = `<img class="Bknight piece" data-indx="${indx}" src="./chessSetIcons/Bknight.png" alt="">`;
    let imgWbishop = `<img class="Wbishop piece" data-indx="${indx}" src="./chessSetIcons/Wbishop.png" alt="">`;
    let imgBbishop = `<img class="Bbishop piece" data-indx="${indx}" src="./chessSetIcons/Bbishop.png" alt="">`;
    let imgWqueen = `<img class="Wqueen piece" data-indx="${indx}" src="./chessSetIcons/Wqueen.png" alt="">`;
    let imgBqueen = `<img class="Bqueen piece" data-indx="${indx}" src="./chessSetIcons/Bqueen.png" alt="">`;
    let imgWking = `<img class="Wking piece" data-indx="${indx}" src="./chessSetIcons/Wking.png" alt="">`;
    let imgBking = `<img class="Bking piece" data-indx="${indx}" src="./chessSetIcons/Bking.png" alt="">`;
...
function queenClicked(pos){
    ...
    for(let a=1;a<9;a++){
        res.push(String(row)+String(a));
    }
    
    for(let b=1;b<9;b++){
        res.push(String(b)+String(col));
    }
...
Wrooks.forEach((Wrook)=>{
    Wrook.addEventListener("click",()=>{
        rookClicked(Wrook.getAttribute("data-indx"));
        clickedAfter("Wrook");
...
Brooks.forEach((Brook)=>{
    Brook.addEventListener("click",()=>{
        rookClicked(Brook.getAttribute("data-indx"));
        clickedAfter("Brook");
...
Wknights.forEach((Wknight)=>{
    Wknight.addEventListener("click",()=>{
        knightClicked(Wknight.getAttribute("data-indx"));
...
Bknights.forEach((Bknight)=>{
    Bknight.addEventListener("click",()=>{
        knightClicked(Bknight.getAttribute("data-indx"))
...
Wbishops.forEach((Wbishop)=>{
    Wbishop.addEventListener("click",()=>{
        bishopClicked(Wbishop.getAttribute("data-indx"));
...
Bbishops.forEach((Bbishop)=>{
    Bbishop.addEventListener("click",()=>{
        bishopClicked(Bbishop.getAttribute("data-indx"));
...
Wking.addEventListener("click",()=>{
    kingClicked(Wking.getAttribute("data-indx"));
    clickedAfter("Wking");
    // Wking.classList.toggle("clicked");
});

Bking.addEventListener("click",()=>{
    kingClicked(Bking.getAttribute("data-indx"));
    clickedAfter("Bking");
...
Wqueen.addEventListener("click",()=>{
    queenClicked(Wqueen.getAttribute("data-indx"));
    clickedAfter("Wqueen");
...
Bqueen.addEventListener("click",()=>{
    queenClicked(Bqueen.getAttribute("data-indx"));
    clickedAfter("Bqueen");
